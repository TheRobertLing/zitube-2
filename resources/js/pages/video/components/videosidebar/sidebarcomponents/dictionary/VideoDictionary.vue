...
<template>
    <VideoSideBarCard :video-tab-details="videoTabDetails" :height="height" class="space-y-4">
        ...
        <div v-if="state === 'results'" class="space-y-4">
            <div v-if="searchResults.length === 0" class="text-muted-foreground text-sm italic">No results found.</div>
