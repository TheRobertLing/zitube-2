...
import HanziRuby from './HanziRuby.vue';
import VideoTranscriptDropdown from './VideoTranscriptDropdown.vue';
...
<template>
    <Card class="flex h-full flex-1 flex-col gap-1">
        <CardHeader>
            ...
            >
                <!-- <span class="text-muted-foreground text-[10px] tracking-wide uppercase">Utilities:</span> -->
                        ...
                        >
                            ...
                            <td class="pt-1 leading-snug">
                                <template v-for="(char, idx) in line.tokenizedChinese" :key="idx">
                                    <HanziRuby :hanzi="char.hanzi" :pinyin="char.pinyin" />
                                </template>
                            </td>
                            <td rowspan="2" class="w-12 rounded-r-xl text-center align-middle">
                                <VideoTranscriptDropdown :line="line" />
                            </td>
                        </tr>
