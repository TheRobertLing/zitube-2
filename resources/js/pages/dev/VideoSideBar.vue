...
<template>
    <div class="gutter scrollable-content flex h-full items-center justify-center overflow-y-auto p-4">
        <Tabs default-value="Transcript" class="h-full w-full" :unmount-on-hide="false">
